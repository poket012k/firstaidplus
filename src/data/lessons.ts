...
export const lessonCategories: LessonCategory[] = [
  {
    ...
    icon: "🧰",
    summary:
      "Know what belongs in every first aid kit and how each item is used. Based on the American Red Cross and British Red Cross recommended kit contents.",
    sections: [
      {
        heading: "Essential dressings & bandages (Red Cross standard)",
        body: [
          "2 absorbent compress dressings (5 x 9 in) for heavy bleeding.",
          "25 adhesive bandages (assorted sizes) for minor cuts and abrasions.",
          "1 roll of adhesive cloth tape (10 yd x 1 in) to secure dressings.",
          "5 sterile gauze pads (3 x 3 in) and 5 sterile gauze pads (4 x 4 in).",
          "2 roller bandages (one 3 in, one 4 in wide) for limb injuries.",
          "2 triangular bandages — used as slings or as broad/narrow bandages.",
        ],
      },
      {
        heading: "Equipment & protective items",
        body: [
          "2 pairs of non-latex disposable gloves (size large) — barrier protection against blood-borne pathogens.",
          "1 CPR breathing barrier (face shield with one-way valve).",
          "1 emergency blanket (mylar foil) to prevent hypothermia and treat shock.",
          "1 instant cold compress for sprains, bruises and burns (after cooling).",
          "Tweezers (for splinters/ticks), scissors with blunt tip, safety pins, and a working flashlight with spare batteries.",
          "Digital oral thermometer (non-mercury) and a first aid instruction booklet.",
        ],
      },
      {
        heading: "Medicines (use only if trained / per local law)",
        body: [
          "2 packets of aspirin (81 mg, chewable) — for suspected heart attack in adults who are not allergic.",
          "Antibiotic ointment packets (e.g. bacitracin) and antiseptic wipes (e.g. benzalkonium chloride / povidone-iodine) for cleaning wounds.",
          "Hydrocortisone 1% ointment for itching, rashes and insect bites.",
          "Oral rehydration salts (WHO formula) for diarrhoea and heat illness.",
          "Paracetamol/acetaminophen for pain and fever; antihistamine tablets for allergic reactions (per local guidance).",
        ],
      },
      {
        heading: "Maintenance & storage (NHS guidance)",
        body: [
          "Check the kit at least every 3 months — replace expired or used items immediately.",
          "Store in a cool, dry place out of children's reach but easily accessible to adults; everyone in the household should know its location.",
          "Keep a separate, weather-sealed kit in your car and a smaller travel kit in any backpack used for hiking or sport.",
        ],
      },
    ],
    sources: [
    ...
    quiz: [
      ...
      { question: "How often should a first aid kit be checked (NHS)?", options: ["Once a year", "Every 5 years", "At least every 3 months", "Only when used"], answer: 2 },
      { question: "Aspirin in a first aid kit is mainly for:", options: ["Headaches", "Suspected heart attack", "Treating fractures", "Cooling burns"], answer: 1 },
    ],
  },
  {
    slug: "human-body",
